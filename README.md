...
- Android StudioからGitHubに直接コードをあげる方法が見つからなかったので、VS codeでFlutterを実行できるようにまた設定し直して、Terminalコマンドでflutter create文を打って作った
フォルダをVS codeで開くことで、VS codeでの編集、iOSシミュレーションができるようになりました。
